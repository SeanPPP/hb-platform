...
namespace BlazorApp.Api.Interfaces.React
{
    ...
    public interface IProductWarehouseReactService
    {
        ...
        Task<ReactTableResponseDto<DomesticProductNotInWarehouseDto>> GetDomesticProductsNotInWarehouseAsync(GetDomesticProductsNotInWarehouseRequestDto request);
