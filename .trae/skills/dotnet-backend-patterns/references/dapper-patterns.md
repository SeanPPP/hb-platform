...
{
  "ConnectionStrings": {
    "Default": "Server=localhost;Database=MyDb;User Id=REDACTED;Password=REDACTED;TrustServerCertificate=True;Min Pool Size=5;Max Pool Size=100;Connection Timeout=30;"
  }
}
```
