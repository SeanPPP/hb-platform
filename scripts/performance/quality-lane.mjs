...
const LANE_COMMANDS = Object.freeze({
  ...
  "pos-ipad": [
    { label: "npm ci", command: "npm", args: ["ci"], cwd: "." },
    {
      label: "pos-ipad typecheck",
      command: "npm",
      args: ["run", "typecheck", "--workspace=@hb/pos-ipad"],
      cwd: ".",
    },
    {
      label: "pos-ipad Expo/Metro bundle",
      command: "npm",
      args: ["run", "verify:metro-bundle", "--workspace=@hb/pos-ipad"],
      cwd: ".",
    },
    {
      label: "pos-ipad test",
      command: "npm",
      args: ["run", "test:ci", "--workspace=@hb/pos-ipad"],
      cwd: ".",
  ...
  "pos-handheld": [
    { label: "npm ci", command: "npm", args: ["ci"], cwd: "." },
    {
      ...
      command: "npm",
      args: ["run", "typecheck", "--workspace=@hb/pos-handheld"],
      cwd: ".",
    },
    {
      label: "pos-handheld Expo/Metro bundle",
      command: "npm",
      args: ["run", "verify:metro-bundle", "--workspace=@hb/pos-handheld"],
      cwd: ".",
    },
    {
      label: "pos-handheld test",
      command: "npm",
      args: ["run", "test:ci", "--workspace=@hb/pos-handheld"],
      cwd: ".",
      environment: { TZ: "Australia/Brisbane" },
    },
  ],
