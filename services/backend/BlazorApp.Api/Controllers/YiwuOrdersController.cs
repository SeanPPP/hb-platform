    ...
    public class YiwuOrdersController : ControllerBase
    {
        ...
        )
        {
            try
            {
                ...
                return Ok(
                    new ApiResponse<PagedResult<YIWU_Order>>
                    {
                        Success = true,
                        Data = result,
                        Message = "获取订单列表成功",
        ...
        public async Task<IActionResult> GetOrder(int id)
        {
            try
            {
                ...
                {
                    return NotFound(
                        new ApiResponse<object> { Success = false, Message = "订单不存在" }
                    );
                }

                return Ok(
                    new ApiResponse<YIWU_Order>
                    {
                        Success = true,
                        Data = order,
                        Message = "获取订单详情成功",
        ...
        public async Task<IActionResult> CreateOrder([FromBody] CreateYiwuOrderDto createDto)
        {
            try
            {
                ...
                {
                    var orderDetails = createDto
                        .OrderDetails.Select(d => new YIWU_OrderDetail
                        {
        ...
        public async Task<IActionResult> UpdateOrder(
            int id,
            [FromBody] UpdateYiwuOrderDto updateDto
        )
        {
            try
            {
                ...
                {
                    return BadRequest(
                        new ApiResponse<object> { Success = false, Message = "订单ID不匹配" }
                    );
                }
                ...
                if (!result)
                {
                    return StatusCode(
                        500,
                        new ApiResponse<object> { Success = false, Message = "更新订单失败" }
                    );
                }
        ...
        public async Task<IActionResult> DeleteOrder(int id)
        {
            try
            {
                ...
                if (!result)
                {
                    return StatusCode(
                        500,
                        new ApiResponse<object> { Success = false, Message = "删除订单失败" }
                    );
                }

                return Ok(new ApiResponse<object> { Success = true, Message = "删除订单成功" });
            }
            catch (Exception ex)
            {
        ...
        )
        {
            try
            {
                ...
                return Ok(
                    new ApiResponse<PagedResult<YIWU_OrderDetail>>
                    {
                        Success = true,
                        Data = result,
                        Message = "获取订单明细成功",
        ...
        public async Task<IActionResult> GetOrderDetail(int id)
        {
            try
            {
                ...
                {
                    return NotFound(
                        new ApiResponse<object> { Success = false, Message = "订单明细不存在" }
                    );
                }

                return Ok(
                    new ApiResponse<YIWU_OrderDetail>
                    {
                        Success = true,
                        Data = detail,
                        Message = "获取订单明细成功",
        ...
        public async Task<IActionResult> CreateOrderDetail(
            [FromBody] CreateYiwuOrderDetailDto createDto
        )
        {
            try
            {
        ...
        public async Task<IActionResult> UpdateOrderDetail(
            int id,
            [FromBody] YIWU_OrderDetail orderDetail
        )
        {
            try
            {
                ...
                {
                    return BadRequest(
                        new ApiResponse<object> { Success = false, Message = "订单明细ID不匹配" }
                    );
                }
                ...
                if (!result)
                {
                    return StatusCode(
                        500,
                        new ApiResponse<object> { Success = false, Message = "更新订单明细失败" }
                    );
                }
        ...
        public async Task<IActionResult> DeleteOrderDetail(int id)
        {
            try
            {
                ...
                return Ok(new ApiResponse<object> { Success = true, Message = "删除订单明细成功" });
            }
            catch (Exception ex)
            {
        ...
        [Authorize(Roles = "Admin,Manager")]
        public async Task<IActionResult> CreateOrdersFromPDA(
            [FromBody] PDAToYiwuOrderDto? options = null
        )
        {
            try
            {
                ...
                {
                    return Ok(
                        new ApiResponse<List<YIWU_Order>>
                        {
                            Success = true,
                            Data = createdOrders,
        ...
        public async Task<IActionResult> GetPDAOrderDetails()
        {
            try
            {
                ...
                return Ok(
                    new ApiResponse<List<YIWU_OrderDetail>>
                    {
                        Success = true,
                        Data = pdaDetails,
                        Message = "获取PDA订单明细成功",
        ...
        public async Task<IActionResult> GroupPDADetailsBySupplier()
        {
            try
            {
                ...
                return Ok(
                    new ApiResponse<Dictionary<string, List<YIWU_OrderDetail>>>
                    {
                        Success = true,
                        Data = groupedDetails,
        ...
        public async Task<IActionResult> BatchExportToExcel([FromBody] BatchExportRequest request)
        {
            try
            {
                ...
                {
                    return BadRequest(
                        new ApiResponse<object> { Success = false, Message = "请选择要导出的订单" }
                    );
                }
                ...
                _logger.LogInformation(
                    "开始批量导出 {OrderCount} 个订单",
                    request.OrderIds.Count()
                );
        ...
        public async Task<IActionResult> GetStatistics()
        {
            try
            {
                ...
                return Ok(
                    new ApiResponse<OrderStatisticsDto>
                    {
                        Success = true,
                        Data = statistics,
                        Message = "获取订单统计信息成功",
