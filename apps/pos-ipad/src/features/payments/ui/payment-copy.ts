...
export const paymentEnglishCopy = {
  ...
  "method.voucher": "Gift card",
  "method.manual-card": "Manual card",
  "manualCard.amountHint": "Record the full remaining balance shown above.",
  "manualCard.instructions": "Use the separate card terminal to take payment. Check that its successful payment amount matches this balance.",
  "manualCard.checked": "I have confirmed the card terminal payment succeeded",
  "manualCard.uncertain": "If payment failed or the result is uncertain, go back and check the terminal before continuing.",
  "manualCard.confirm": "Confirm card payment",
  "field.manual-card-confirmation-required": "Confirm that the card terminal payment succeeded before recording it.",
  "error.MANUAL_CARD_CONFIRMATION_REQUIRED": "Confirm that the card terminal payment succeeded before recording it.",
  "error.MANUAL_CARD_FULL_BALANCE_REQUIRED": "Manual card payment must cover the full remaining balance.",
  "error.MANUAL_CARD_SALE_ONLY": "Manual card payment is available for regular sales only.",
  "error.MANUAL_CARD_CONFIGURATION_DISABLED": "Manual card payment is disabled in payment settings.",
  "error.MANUAL_CARD_CONFIGURATION_LOAD_FAILED": "Manual card payment settings could not be loaded.",
  ...
  "voucher.label": "Gift card code",
  "voucher.placeholder": "Scan or enter gift card",
  "voucher.captured": "Gift card captured securely",
  ...
  "status.ready.hint": "Online card and gift card payments create a durable attempt before contacting the provider.",
  ...
  "field.voucher-required": "Scan or enter a gift card code.",
  ...
  "error.VOUCHER_CONFIGURATION_DISABLED": "Gift card payments are disabled.",
  "error.VOUCHER_CONFIGURATION_LOAD_FAILED": "Gift card configuration could not be loaded.",
  ...
  "error.TENDER_REVERSAL_RECOVERY_REQUIRED": "A saved gift card reversal must be recovered before taking another tender.",
  "error.TENDER_REVERSAL_BLOCKED": "Gift card reversal requires supervisor support and cannot be retried.",
  ...
  "error.PAYMENT_QUANTITY_UNSUPPORTED": "This checkout has an unsupported item quantity. Use positive whole numbers within the supported range before taking payment.",
  ...
  "error.VOUCHER_CONTEXT_NOT_PREPARED": "The gift card context was not saved safely. Scan the gift card again.",
...
const paymentChineseCopy = {
  ...
  "method.linkly-cloud": "Linkly",
  "method.voucher": "礼品卡",
  "method.manual-card": "手动刷卡",
  "manualCard.amountHint": "将按上方显示的全部剩余金额记录付款。",
  "manualCard.instructions": "请在独立刷卡机上完成收款，核对其付款成功金额与本次剩余应付一致。",
  "manualCard.checked": "已确认刷卡机付款成功",
  "manualCard.uncertain": "若付款失败或结果不确定，请返回核对刷卡机后再继续。",
  "manualCard.confirm": "确认刷卡付款",
  "field.manual-card-confirmation-required": "请先确认刷卡机已付款成功，再记录付款。",
  "error.MANUAL_CARD_CONFIRMATION_REQUIRED": "请先确认刷卡机已付款成功，再记录付款。",
  "error.MANUAL_CARD_FULL_BALANCE_REQUIRED": "手动刷卡必须支付全部剩余金额。",
  "error.MANUAL_CARD_SALE_ONLY": "手动刷卡仅支持普通销售。",
  "error.MANUAL_CARD_CONFIGURATION_DISABLED": "支付设置中尚未启用手动刷卡。",
  "error.MANUAL_CARD_CONFIGURATION_LOAD_FAILED": "无法读取手动刷卡设置。",
  ...
  "voucher.label": "礼品卡码",
  "voucher.placeholder": "扫描或输入礼品卡码",
  "voucher.captured": "礼品卡码已安全获取",
  "summary.title": "支付汇总",
  "summary.total": "订单总额",
  "summary.paid": "已付款",
  ...
  "status.ready.hint": "银行卡和礼品卡会先耐久保存支付尝试，再联系支付方。",
  ...
  "field.voucher-required": "请扫描或输入礼品卡码。",
  ...
  "error.VOUCHER_CONFIGURATION_DISABLED": "礼品卡支付已停用。",
  "error.VOUCHER_CONFIGURATION_LOAD_FAILED": "无法读取礼品卡配置。",
  ...
  "error.TENDER_REVERSAL_RECOVERY_REQUIRED": "必须先恢复已保存的礼品卡撤销，才能继续收款。",
  "error.TENDER_REVERSAL_BLOCKED": "礼品卡撤销已阻断，必须由主管处理且不能重试。",
  ...
  "error.PAYMENT_QUANTITY_UNSUPPORTED": "此订单包含不支持的商品数量。收款前请将数量调整为有效的正整数。",
  ...
  "error.VOUCHER_CONTEXT_NOT_PREPARED": "礼品卡上下文未安全保存，请重新扫描礼品卡。",
