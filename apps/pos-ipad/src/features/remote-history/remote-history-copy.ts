export const remoteHistoryEnglishCopy = {
  ...
  "filters.invalidDate": "Enter a valid date range in YYYY-MM-DD format.",
  "list.title": "Orders",
  ...
  "readonly.note":
    "Read-only view: refund and recall are not available from remote history.",
...
const remoteHistoryChineseCopy = {
  ...
  "filters.invalidDate": "请输入有效的 YYYY-MM-DD 日期范围。",
  "list.title": "订单",
  "list.items": "{{count}} 行",
  "list.payment": "付款",
  "list.status": "状态",
  ...
  "readonly.note": "只读页面：远程历史不提供退款或取单。",
