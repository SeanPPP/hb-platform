...
// src/pages/System/Users/time.ts
...
function formatUserLocalDateTime(value, emptyValue = "--") {
  if (!value) {
    return emptyValue;
  }
  const parsed = (0, import_dayjs.default)(normalizeUtcTimestamp(value));
  return parsed.isValid() ? parsed.format("YYYY-MM-DD HH:mm:ss") : value;
}

// src/pages/System/Users/time.test.ts
function assertEqual(actual, expected, message) {
  if (actual !== expected) {
    throw new Error(`${message}. Expected: ${String(expected)}, received: ${String(actual)}`);
  }
}
var timezoneOffsetMinutes = (/* @__PURE__ */ new Date()).getTimezoneOffset();
var expectedHour = String((24 - timezoneOffsetMinutes / 60) % 24).padStart(2, "0");
assertEqual(
...
assertEqual(
  formatUserLocalDateTime(void 0, "-"),
  "-",
  "\u7A7A\u65F6\u95F4\u5E94\u663E\u793A\u9875\u9762\u4F20\u5165\u7684\u5360\u4F4D\u7B26"
);
