...
export default function PosmSalesOrdersPage() {
  ...
  const columns: ColumnsType<PosmSalesOrder> = [
    ...
    },
    {
      ...
      render: (_, record) => formatPosmSalesOrderTime(record.orderTime, 'YYYY-MM-DD'),
    },
    {
      key: 'time',
      ...
      render: (_, record) => formatPosmSalesOrderTime(record.orderTime, 'HH:mm:ss'),
    },
    {
      key: 'skuCount',
    ...
    {
      key: 'quantityTotal',
      title: t('posmOrders.quantityTotal'),
      dataIndex: 'quantityTotal',
      width: 80,
      align: 'right',
      sorter: true,
      sortOrder: sortOrderFor('quantityTotal'),
      ...numberFilterProps(
        'quantityTotalMin',
        'quantityTotalMax',
        t('posmOrders.quantityTotal'),
        true,
      ),
    },
    {
                    ...
                    {detail.paymentDetails && detail.paymentDetails.length > 0 && (
                      <Card title={t('posmOrders.paymentInfo')} size="small">
                        {detail.paymentDetails.map((payment, index) => (
                          ...
                          >
                            <Text>
                              {formatPosmSalesOrderTime(payment.paymentTime, 'HH:mm:ss')}
                            </Text>
                            <Tag color="green">
