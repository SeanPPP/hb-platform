...
Navigation follows the standard iOS hierarchy: tapping **Home** returns directly to the workspace root, while a left-edge swipe returns from secondary and tertiary screens to the previous level.
