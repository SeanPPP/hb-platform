...
const styles = StyleSheet.create({
  ...
  searchbar: { marginHorizontal: 16, marginTop: 12, backgroundColor: "#FFFFFF", borderRadius: 8 },
  listContent: { flexGrow: 1, padding: 16, paddingBottom: 18, gap: 12 },
  itemCard: { backgroundColor: "#FFFFFF", borderColor: "#E4E7EC", borderRadius: 12 },
  itemContent: { gap: 12 },
  productRow: { flexDirection: "row", gap: 12 },
  productImage: { width: 84, height: 84, borderRadius: 8, backgroundColor: "#F2F4F7" },
  imagePlaceholder: {
    width: 84,
    height: 84,
    alignItems: "center",
