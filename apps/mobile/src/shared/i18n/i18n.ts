...
if (!i18n.isInitialized) {
  void i18n.use(initReactI18next).init({
    ...
    defaultNS: "common",
    ns: ["appDownloads", "wpfVersions", "common", "advertisements", "attendance", "login", "home", "cart", "domesticPurchase", "deviceManagement", "employeeProfile", "employeeProfileReview", "installmentOrders", "localSupplierInvoices", "orders", "promotions", "preorder", "seasonalCards", "settings", "storeVouchers", "productQuery", "productInsights", "warehouseProductInsights", "salesOrders", "userManagement", "warehouse", "workbench"],
    interpolation: {
      escapeValue: false,
    },
