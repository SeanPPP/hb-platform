...
export const paymentEnglishCopy = {
  ...
  "error.SQUARE_CONFIGURATION_MISSING": "Square is not configured on this handheld device.",
  ...
  "error.LINKLY_CONFIGURATION_MISSING": "Linkly is not configured on this handheld device.",
...
const paymentChineseCopy = {
  ...
  "error.SQUARE_CONFIGURATION_MISSING": "此手持设备尚未配置 Square。",
  ...
  "error.LINKLY_CONFIGURATION_MISSING": "此手持设备尚未配置 Linkly。",
