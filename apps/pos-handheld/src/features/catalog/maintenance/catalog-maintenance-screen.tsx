...
export const CATALOG_MAINTENANCE_MIN_TOUCH_TARGET = 48;
...
const styles = StyleSheet.create({
  ...
  workspace: { flex: 1, flexDirection: "column", gap: 16 },
  ...
  panelCompact: { flexGrow: 0, padding: 16 },
  panelLabel: {
    color: posColors.mutedInk,
    fontSize: 13,
    fontWeight: "800",
