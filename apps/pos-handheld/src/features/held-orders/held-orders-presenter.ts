...
export type HeldOrderViewRow = Readonly<{
  holdId: string;
  local: HeldOrderSummaryWithSynthetic | null;
...
export class HeldOrdersPresenter {
  ...
  private localRowsCache: readonly HeldOrderSummaryWithSynthetic[] = [];
...
function toLocalViewRows(
  rows: readonly HeldOrderSummaryWithSynthetic[],
): HeldOrderViewRow[] {
...
function mergeHeldOrderRows(
  localRows: readonly HeldOrderSummaryWithSynthetic[],
