export const heldOrdersEnglishCopy = {
  ...
  "detail.hint":
    "Review this terminal-local hold before changing its durable state.",
  ...
  "result.hold-committed-cart-not-cleared":
    "The sale was held; verify the cart before continuing.",
  "result.hold-fence-not-cleared":
    "The sale was held and the terminal remains blocked until cart recovery completes.",
  "result.terminal-fence-blocked":
    "Finish the active held-sale recovery before continuing.",
  ...
  "result.rollback-failed":
    "Recall needs supervisor recovery before continuing.",
  "result.release-failed":
    "Recall remains in recovery. Use Recover hold explicitly.",
...
const heldOrdersChineseCopy = {
  ...
  "detail.title": "挂单详情",
  "detail.hint": "更改耐久状态前，请核对此终端的本地挂单。",
  "empty.title": "此终端没有挂单",
...
const heldOrdersCopy = {
  en: heldOrdersEnglishCopy,
  zh: heldOrdersChineseCopy,
} as const;
