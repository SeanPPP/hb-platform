...
public sealed class PosTerminalCashPaymentViewModelTests
{
    ...
    [Fact]
    public void Payment_page_prepare_for_entry_drops_historical_recovery_lock_for_new_order()
    {
        var cart = new PosCartService();
    ...
    [Fact]
    public async Task Payment_page_handoff_qualification_failure_opens_recovery_center_and_keeps_order_locked()
    {
        var cart = new PosCartService();
