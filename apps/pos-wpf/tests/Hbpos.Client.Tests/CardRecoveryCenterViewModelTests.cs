...
public sealed class CardRecoveryCenterViewModelTests
{
    ...
    public void Center_resources_are_bilingual_complete_and_keep_parallel_wiring_keys_stable()
    {
        ...
        var requiredKeys = new[]
        {
            ...
            "cardRecovery.linkly.supervisorNotPaidFinalizeFailed",
            "cardRecovery.refund.confirmedOrderSaveFailed",
            "cardRecovery.refund.confirmedRestoreFailed",
            "cardRecovery.refund.retryDraftInvalid",
            "cardRecovery.refund.retryRestoreFailed",
            "cardRecovery.square.stateChanged",
